...
const TypingIndicator = () => (
  <div className="flex items-center gap-3 mb-4 animate-fade-in">
    ...
    <div className="bg-white/[0.05] border border-white/[0.1] rounded-2xl rounded-bl-sm px-4 py-3 max-w-[70%]">
    ...
    return (
      <div className="h-[24rem] flex items-center justify-center">
        <div className="text-center px-6 py-8">
          <div className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 border border-white/[0.12] flex items-center justify-center animate-float shadow-lg shadow-blue-500/10">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <div className="px-3 py-1.5 bg-white/[0.05] border border-white/[0.1] rounded-full text-xs text-slate-300 hover:bg-white/[0.08] hover:border-white/[0.15] transition-all duration-200 cursor-default">
              Weather queries
            </div>
            <div className="px-3 py-1.5 bg-white/[0.05] border border-white/[0.1] rounded-full text-xs text-slate-300 hover:bg-white/[0.08] hover:border-white/[0.15] transition-all duration-200 cursor-default">
              Math calculations
              ...
              <div
                className={`relative px-4 py-3 text-sm leading-relaxed transition-all duration-200 ${
                  isUser
                    ...
                    : 'bg-white/[0.05] text-slate-50 border border-white/[0.1] rounded-2xl rounded-bl-sm backdrop-blur-sm'
                }`}
              >
